      ...
      <div className="p-8">
        <div className="flex justify-between items-center mb-2">
          ...
          <div className="flex items-center">
            ...
            <h3 className="ml-2 text-1xl font-bold text-gray-900">Ship Bay Layouts</h3>
          </div>

          {/* Middle - Actions */}
          <div className="flex items-center gap-2 text-xs">
            <button onClick={() => setShowGuideModal(true)} className="inline-flex items-center px-4 py-2 border border-blue-300 rounded-md shadow-sm  font-medium text-blue-700 bg-blue-50 hover:bg-blue-100">
              <FiHelpCircle className="mr-2" />
              Layout Guide
            </button>
            <button onClick={() => setShowCreateForm(true)} className="inline-flex items-center px-4 py-2 border border-green-300 rounded-md shadow-sm  font-medium text-green-700 bg-green-50 hover:bg-green-100">
              Create New Layout
            </button>
          </div>
        ...
        <div className="flex items-center space-x-2 mb-2">
          {/* <h3 className="text-1lg font-semibold text-gray-800">Ship Layouts</h3> */}
        ...
        {layouts.length === 0 ? (
          <div className="text-center py-8">
            <svg className="mx-auto h-4 w-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path
                strokeLinecap="round"
                strokeLinejoin="round"
                strokeWidth="2"
