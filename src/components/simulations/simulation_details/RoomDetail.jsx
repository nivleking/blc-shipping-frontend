          ...
          <TabPanels>
            ...
            <TabPanel>
              {isLoading ? (
                ...
                <CapacityUptakePanel roomId={roomId} totalRounds={room.total_rounds} />
              )}
            </TabPanel>

            <TabPanel>
              <div className="bg-white shadow rounded-lg p-6">
                <h2 className="text-lg font-semibold mb-4">Stowage</h2>
            ...
            <TabPanel>
              {isLoading ? (
                ...
                <WeeklyPerformancePanel totalRounds={room.total_rounds} roomId={roomId} />
              )}
            </TabPanel>
